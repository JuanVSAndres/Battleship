...
public class NavyTest {
    ...
    /*
    @Test
    @DisplayName("GIVEN a Juan WHEN his girlfriend left him THEN return f en el chat ")
    public void shouldCry()
    {
        Navy n = new Navy("JUAN");
        boolean perdonaronAJuan = true;
        System.out.println(n.fEnElChatPorJuan());
    }
     */
}
